...
const MyTrainingProgram12 = () => {
  return (
    <View style={styles.myTrainingProgram}>
      ...
      <View style={[styles.myTrainingProgramChild1, styles.childLayout]} />
      <Image
      ...
      <Image
        ...
        source={require("../assets/vector.png")}
      />
      <View style={[styles.boustParent, styles.childLayout]}>
...
export default MyTrainingProgram12;
