    ...
    <View style={styles.myTrainingProgram}>
      ...
      <View style={[styles.groupParent, styles.groupLayout]}>
        <View style={styles.groupContainer}>
          <View style={[styles.rectangleParent, styles.groupViewLayout]}>
            ...
            <Text style={[styles.cross, styles.crossLayout]}>CROSS</Text>
          </View>
          <Image
          ...
          <View style={[styles.rectangleGroup, styles.groupViewLayout]}>
            ...
            <Text style={[styles.drive, styles.crossLayout]}>{`DRIVE `}</Text>
          </View>
          ...
          <View style={[styles.groupView, styles.groupViewLayout]}>
            ...
            <Text style={[styles.service, styles.lobTypo]}>SERVICE</Text>
          </View>
          <View
          ...
          >
            ...
            <Text style={[styles.text1, styles.textTypo2]}>ВСЕ</Text>
          </View>
          <Image
          ...
          <Image
            ...
            resizeMode="cover"
            source={require("../assets/arrow-311.png")}
          />
          ...
          <View style={[styles.rectangleParent3, styles.parentPosition]}>
            ...
            <Text style={[styles.boust, styles.crossLayout]}>BOUST</Text>
          </View>
          <Image
          ...
          <View style={[styles.groupParent1, styles.parentPosition]}>
            <View style={[styles.rectangleParent4, styles.groupViewLayout]}>
              ...
              <Text style={[styles.drop, styles.lobTypo]}>DROP</Text>
            </View>
            <Image
      ...
      <View style={styles.groupChild81Position}>
        ...
        <Image
          ...
          source={require("../assets/ellipse-81.png")}
        />
        <Text style={[styles.text7, styles.lobTypo]}>ВЫБРАТЬ РАЗДЕЛ</Text>
      ...
      <View style={[styles.groupParent2, styles.groupParentLayout]}>
        <View style={[styles.rectangleParent7, styles.groupParentLayout]}>
          ...
          <Text style={[styles.text8, styles.textTypo]}>
            Для изменения сложности и количества игроков используй фильтр
          </Text>
          <Text style={[styles.text9, styles.textTypo]}>Понятно</Text>
        </View>
        <Image
        ...
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/ellipse-233.png")}
        />
      </View>
    </View>
  );
...
export default MyTrainingProgram9;
