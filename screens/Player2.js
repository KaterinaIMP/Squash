  ...
  return (
    <View style={styles.player}>
      ...
      <View style={[styles.workout, styles.workoutLayout]}>
        ...
        <Image
          style={[styles.exercisesIcon, styles.iconLayout1]}
          resizeMode="cover"
      ...
      <View style={styles.daysOfTheWeekParent}>
...
тренировку`}</Text>
      ...
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/group-1582.png")}
      />
      <Image
      ...
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/group-1612.png")}
      />
      <View style={[styles.menu, styles.menuPosition]}>
        <View style={[styles.plashka1, styles.iconLayout]} />
        ...
        <View style={styles.home}>
          <Pressable
            style={styles.homeUnactive}
            onPress={() => navigation.navigate("Player2")}
          >
            <Image
